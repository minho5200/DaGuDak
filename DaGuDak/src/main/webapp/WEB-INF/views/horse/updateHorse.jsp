...
<section class="contact-section" id="contact-section">
   <div class="container">
      <div class="row block-9"
         ...
         <!-- form -->
         <form name="horseUpdate" method="post"
            action="${pageContext.request.contextPath}/horse/update"
            class="p-4 p-md-5 contact-form">
               ...
               <div class="col-md-12">
                  ...
                  <!-- horse_no -> hidden -->
                  <input type="hidden" name="horse_no" class="horse_no" value="${horse.horse_no}">
                  <!-- *** -->
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     <input type="text" name="kind" class="form-control" value="${horse.kind}"
                        maxlength="10" placeholder="품종을 입력하세요" required>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="form-group">
                     <input type="text" name="gender" class="form-control" value="${horse.gender}"
               ...
               <div class="col-md-6">
                  <div class="form-group">
                     <input type="text" name="weight" class="form-control" value="${horse.weight}"
            ...
            <div class="col-md-12">속력</div>
               <div class="col-md-3">
                  <div class="form-group">
                     <input type="text" name="speed1" class="form-control" value="${horse.speed1}"
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <input type="text" name="speed2" class="form-control" value="${horse.speed2}"
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     <input type="text" name="speed3" class="form-control" value="${horse.speed3}"
                        maxlength="1" placeholder="속력3" required>
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     <input type="text" name="speed4" class="form-control" value="${horse.speed4}"
